                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              '1',
                              style: AppText.regulerText.copyWith(
                                  fontSize: 18, color: AppColors.kSecondColor),
                            ),
                            const SizedBox(
                              width: 20.0,
                            ),
                        ...
                        Text(
                          'Rp.10.000',
                          style: AppText.boldText.copyWith(
                              fontSize: 16, color: AppColors.kSecondColor),
                        )
                      ],
                    ),
                    const SizedBox(
                    ...
                    Text(
                      ...
                      style: AppText.boldText
                          .copyWith(fontSize: 16, color: AppColors.kGreyColor),
                    ),
                    const SizedBox(
                      height: 10.0,
                    ),
                    ...
                    const Spacer(),
                    QProcessButton(onTap: () {}, title: 'Add To Cart')
                  ],
                ),
              ),
            ),
